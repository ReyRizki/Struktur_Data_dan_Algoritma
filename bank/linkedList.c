...
// Version		: V 2.6 (Calibrated for Customer ADT)
...
{
    return (index >= listSize(list)) ? createCustomer('x', createTime(0, 0, 0), 0) : addressAt(list, index)->data;
}
